...
class ScreenUtil {
  static const Size defaultSize = Size(390, 844);
  ...
  static void configure({
    ...
    final orientation = deviceData?.orientation ?? (deviceSize.width > deviceSize.height ? Orientation.landscape : Orientation.portrait);
  ...
  DeviceType deviceType() {
    ...
    switch (Platform.operatingSystem) {
      ...
      case 'ios':
        ...
        if ((orientation == Orientation.portrait && screenWidth < 600) || (orientation == Orientation.landscape && screenHeight < 600)) {
          deviceType = DeviceType.mobile;
        } else {
